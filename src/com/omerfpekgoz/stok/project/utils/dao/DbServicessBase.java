...
public class DbServicessBase<T> implements IDbServicess<T> {
		...
		try {
			...
			for (int i = 0; i < field.length; i++) {
				...
				if (field[i].get(temp) != null && !field[i].get(temp).equals("")) {
					// System.out.println(field[i].getType().getName().substring(field[i].getType().getName().lastIndexOf('.')
					// + 1,field[i].getType().getName().length()));
					if (field[i].getType().getName().substring(field[i].getType().getName().lastIndexOf('.') + 1,
							field[i].getType().getName().length()).equals("Integer")) {
						cr.add(Restrictions.eq(field[i].getName(), field[i].get(temp)));
					}
					if (field[i].getType().getName().substring(field[i].getType().getName().lastIndexOf('.') + 1,
							field[i].getType().getName().length()).equals("Category")) {
						cr.add(Restrictions.eq(field[i].getName(),field[i].get(temp)));
					}
					if (field[i].getType().getName().substring(field[i].getType().getName().lastIndexOf('.') + 1,
							field[i].getType().getName().length()).equals("Products")) {
						cr.add(Restrictions.eq(field[i].getName(), field[i].get(temp)));
					}
					if (field[i].getType().getName().substring(field[i].getType().getName().lastIndexOf('.') + 1,
							field[i].getType().getName().length()).equals("Sales")) {
						cr.add(Restrictions.eq(field[i].getName(), field[i].get(temp)));
					}
					if (field[i].getType().getName().substring(field[i].getType().getName().lastIndexOf('.') + 1,
							field[i].getType().getName().length()).equals("Date")) {
						cr.add(Restrictions.eq(field[i].getName(), field[i].get(temp)));
					}
					
					if (field[i].getType().getName().substring(field[i].getType().getName().lastIndexOf('.') + 1,
							field[i].getType().getName().length()).equals("Customer")) {
						cr.add(Restrictions.eq(field[i].getName(), field[i].get(temp)));
					}
				}
				if (field[i].get(temp) != null && !field[i].get(temp).equals("")) {
	...
	public List<T> searchBetween(T temp,Date ikiTarihBaslangic,Date ikiTarihBitis) {
		List<T> results;
		try {
			Criteria cr = ss.createCriteria(temp.getClass());
			Field[] field = temp.getClass().getDeclaredFields();
			
				field[5].setAccessible(true);
				if (field[5].get(temp) != null && !field[5].get(temp).equals("")) {
					
					if (field[5].getType().getName().substring(field[5].getType().getName().lastIndexOf('.') + 1,
							field[5].getType().getName().length()).equals("Date")) {
						cr.add(Restrictions.between(field[5].getName(),ikiTarihBaslangic, ikiTarihBitis));
					}
